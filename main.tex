...
\caption{Bias in mean annual near-surface air temperature of each simulation with respect to the daily gridded observational CLIMATE-GRID dataset over Belgium, for the period 1992--2022. (a) ALARO-25km, (b) ALARO-12km, (c) ALARO-4km.}
\label{fig:tas_bias}
\end{figure*}
...
\caption{The annual cycle of the temperature bias (a) and relative precipitation bias (b) for each simulation (25 km, 12.5 km, and 4 km resolutions) with respect to the gridded observational CLIMATE-GRID dataset, averaged over Belgium, for the period 1992--2022.}
...
\caption{Relative bias in mean annual precipitation of each simulation with respect to the daily gridded observational CLIMATE-GRID dataset over Belgium, for the period 1992--2022. (a) ALARO-25km, (b) ALARO-12km, (c) ALARO-4km.}
\label{fig:pr_bias}
\end{figure*}
...
\caption{Bias in mean seasonal near-surface air temperature of each simulation (columns: ALARO-25km, ALARO-12km, ALARO-4km) with respect to the daily gridded observational CLIMATE-GRID dataset over Belgium, for the period 1992--2022. Rows: (a) Winter (DJF), (b) Spring (MAM), (c) Summer (JJA), (d) Autumn (SON).}
\label{fig:tas_bias_seasons}
\end{figure*}
\newpage
\begin{figure*}[h!]
\includegraphics[width=12cm]{figures/figD2.pdf}
\caption{Bias in mean seasonal precipitation of each simulation (columns: ALARO-25km, ALARO-12km, ALARO-4km) with respect to the daily gridded observational CLIMATE-GRID dataset over Belgium, for the period 1992--2022. Rows: (a) Winter (DJF), (b) Spring (MAM), (c) Summer (JJA), (d) Autumn (SON).}
