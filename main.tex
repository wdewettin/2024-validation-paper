...
\caption{Annual-mean difference between ALARO-12km and ALARO-12km-noSFX (i.e.\ the effect of introducing SURFEX at fixed 12.5\,km resolution) over Belgium, 1992--2022. (a) Near-surface air temperature difference. (b) Relative precipitation difference. Domain-averaged values are reported above each panel.}
\label{fig:surfex_diff}
\end{figure*}
Figure~\ref{fig:surfex_diff} shows the annual-mean difference between ALARO-12km and ALARO-12km-noSFX.
