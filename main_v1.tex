...
\title{Validation of the ALARO1-SFX regional climate model over Belgium across different resolutions}
...
\codeavailability{For the code of the ALARO1-SFX model we refer to the “Code availability” section in \citet{termonia_aladin_2018}.}
